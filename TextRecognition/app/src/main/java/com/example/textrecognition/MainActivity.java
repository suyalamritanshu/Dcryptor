...
public class MainActivity extends AppCompatActivity {
    ...
    private void pickCamera() {
        ...
        values.put(MediaStore.Images.Media.TITLE, "NewPic");  //for title of the picture
        values.put(MediaStore.Images.Media.DESCRIPTION, "Recognize the text");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == RESULT_OK){
            if (requestCode == IMAGE_PICK_GALLERY){
                //we have image from gallery now crop it
                CropImage.activity(data.getData())
                        .setGuidelines(CropImageView.Guidelines.ON)  //enable image guidelines
                .start(this);
            }
            if (requestCode == IMAGE_PICK_CAMERA){
                //we have image from camera now crop it
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE){
            ...
            if (resultCode == RESULT_OK){
                ...
                //get drawable bitmap for text recogniiton
